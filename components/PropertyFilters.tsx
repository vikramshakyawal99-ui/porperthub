...
export default function PropertyFilters({
  ...
  const inputClass =
    "w-full rounded-xl border border-slate-200 bg-white px-4 py-3 text-sm font-medium text-slate-900 placeholder:text-slate-400 outline-none transition focus:border-green-500 focus:ring-2 focus:ring-green-100";

  const selectClass =
    "w-full rounded-xl border border-slate-200 bg-white px-4 py-3 text-sm font-medium text-slate-900 outline-none transition focus:border-green-500 focus:ring-2 focus:ring-green-100";

  return (
    <div className="mb-8 rounded-3xl border border-green-100 bg-green-50/60 p-5 shadow-[0_12px_35px_rgba(20,83,45,0.08)] md:p-7">
      <div className="mb-5 flex items-center justify-between gap-4">
        ...
        <button
          ...
          className="rounded-xl border border-green-600 bg-white px-4 py-2 text-sm font-bold text-green-700 transition hover:bg-green-50"
        >
          Clear Filters
        </button>
      </div>
      ...
      <div className="relative z-50 mt-5 flex flex-col-reverse gap-3 pointer-events-auto sm:flex-row sm:justify-end">
        <button
          ...
          className="relative z-50 w-full cursor-pointer pointer-events-auto rounded-xl bg-green-600 px-7 py-3 text-sm font-black text-white shadow-lg shadow-green-600/20 transition hover:bg-green-700 sm:w-auto"
        >
          ✓ Apply Filters
        </button>
      </div>
