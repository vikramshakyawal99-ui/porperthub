...
<div className="bg-zinc-900 rounded-2xl p-6">
<h2 className="text-3xl font-bold text-[#d4a855]">
...
<Link
href="/properties"
className="bg-[#60A5FA] p-6 rounded-2xl font-bold text-xl"
>
🏠 Browse Properties
</Link>
...
<div className="mt-10">
...

  {
    ...
    <div className="rounded-2xl border border-white/10 bg-zinc-900 p-6">
      ...
      <Link
        href="/"
        className="mt-4 inline-block rounded-xl bg-[#d4a855] px-5 py-3 font-bold text-[#080b12]"
      >
        ...
        loanApplications.map((application:any) => {
          ...
          const statusClass =
            status === "sanctioned" || status === "disbursed"
              ...
              : "bg-[#d4a855]/10 text-[#d4a855] border-[#d4a855]/20";
...
className="inline-block mt-4 bg-[#60A5FA] px-4 py-2 rounded-xl"
>
View Property
</Link>
